...
function start() {
  ...
  function control(e) {
    ...
    if (e.keyCode === 39 && direction != -1 && letMove) {
      //key RIGHT
      direction = 1;
      letMove = false;
    } else if (e.keyCode === 38 && direction != +width && letMove) {
      //key UP
      direction = -width;
      letMove = false;
    } else if (e.keyCode === 37 && direction != 1 && letMove) {
      //key LEFT
      direction = -1;
      letMove = false;
    } else if (e.keyCode === 40 && direction != -width && letMove) {
      //key DOWN
      direction = +width;
      letMove = false;
    }
